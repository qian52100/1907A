      ...
      <table>
       <tr>
        <td width="50%">
         ...
         <time>创建日期：{{date("Y-m-d h:i:s",$info->ctime)}}<br />
失效日期：2015-9-12</time>
         <strong class="orange">¥{{$info->order_amount}}</strong>
        </td>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%"><a href="{{url('order/orderpay/'.$info->order_id)}}" class="jiesuan">立即支付</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->

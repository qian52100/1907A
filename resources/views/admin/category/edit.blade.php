...
<h3 align="center">分类编辑</h3><a href="{{url('category')}}">分类列表</a><hr>
@if ($errors->any())
...
<form action="{{url('category/update/'.$res->cate_id)}}" method="post" id="myform">
    @csrf
                ...
                <div class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="cate_name" value="{{$res->cate_name}}" placeholder="分类名称" class="col-xs-10 col-sm-5" name="cate_name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="parent_id">
                                    ...
                                    @foreach($data as $v)
                                        <option value="{{$v->cate_id}}" {{$res->parent_id==$v->cate_id ? 'selected' : ''}}>{{str_repeat('-',$v->level*5)}}{{$v->cate_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

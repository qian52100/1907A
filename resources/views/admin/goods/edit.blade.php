...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                <h3 align="center">商品编辑</h3><a href="{{url('goods')}}">商品列表</a>
                @if ($errors->any())
                ...
                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="{{url('goods/update/'.$da->goods_id)}}">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="goods_name" placeholder="商品名称"  value="{{$da->goods_name}}" name="goods_name"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-2" placeholder="商品价格" value="{{$da->goods_price}}" name="goods_price"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-3" placeholder="库存数量" value="{{$da->goods_num}}" name="goods_num" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-5"  placeholder="商品积分" name="goods_score" value="{{$da->goods_score}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">商品图片 </label>
                         <div class="col-sm-9">
                             <img src="{{env('UPLOAD_URL')}}{{$da->goods_img}}" width="100px">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="goods_desc" id="editor">{{$da->goods_desc}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="radio" name="goods_up" value="1" {{($da->goods_up)==1 ? 'checked' : ''}}>是
                            <input type="radio" name="goods_up" value="2"  {{($da->goods_up)==2 ? 'checked' : ''}}>否
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="radio" name="goods_new" value="1"  {{($da->goods_new)==1 ? 'checked' : ''}}>是
                            <input type="radio" name="goods_new" value="2"  {{($da->goods_new)==2 ? 'checked' : ''}}>否
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="radio" name="goods_best" value="1"  {{($da->goods_best)==1 ? 'checked' : ''}}>是
                            <input type="radio" name="goods_best" value="2"  {{($da->goods_best)==2 ? 'checked' : ''}}>否
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="radio" name="goods_host" value="1"  {{($da->goods_host)==1 ? 'checked' : ''}}>是
                            <input type="radio" name="goods_host" value="2"  {{($da->goods_host)==2 ? 'checked' : ''}}>否
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="brand_id">
                                ...
                                @foreach($res as $v)
                                    <option value="{{$v->brand_id}}" {{$da->brand_id==$v->brand_id ? 'selected' : ''}}>{{$v->brand_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="cate_id">
                                ...
                                @foreach($data as $v)
                                    <option value="{{$v->cate_id}}" {{$da->cate_id==$v->cate_id ? 'selected' : ''}}>{{str_repeat("--",$v->level*5)}}{{$v->cate_name}}</option>
                                @endforeach
                            </select>
    ...
    $(function(){
        ...
        function checkName(){
            ...
            if(!reg.test(goods_name)){
                ...
                var goods_id="{{$da->goods_id}}";
                var flag=true;
                $.ajax({
                    method:"post",
                    url:"{{url('goods/checkName1')}}",
